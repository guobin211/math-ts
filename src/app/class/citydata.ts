    ...
    children: [

      {
        ...
        children: [
          ...
          {value: '玄武区', label: '玄武区',isLeaf: true},

          {value: '白下区', label: '白下区',isLeaf: true},

          {value: '秦淮区', label: '秦淮区',isLeaf: true},

          {value: '建邺区', label: '建邺区',isLeaf: true},

          {value: '鼓楼区', label: '鼓楼区',isLeaf: true},

          {value: '下关区', label: '下关区',isLeaf: true},

          {value: '浦口区', label: '浦口区',isLeaf: true},

          {value: '栖霞区', label: '栖霞区',isLeaf: true},

          {value: '雨花台区', label: '雨花台区',isLeaf: true},

          {value: '江宁区', label: '江宁区',isLeaf: true},

          {value: '六合区', label: '六合区',isLeaf: true},

          {value: '溧水县', label: '溧水县',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '崇安区', label: '崇安区',isLeaf: true},

          {value: '南长区', label: '南长区',isLeaf: true},

          {value: '北塘区', label: '北塘区',isLeaf: true},

          {value: '锡山区', label: '锡山区',isLeaf: true},

          {value: '惠山区', label: '惠山区',isLeaf: true},

          {value: '滨湖区', label: '滨湖区',isLeaf: true},

          {value: '江阴市', label: '江阴市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '云龙区', label: '云龙区',isLeaf: true},

          {value: '九里区', label: '九里区',isLeaf: true},

          {value: '贾汪区', label: '贾汪区',isLeaf: true},

          {value: '泉山区', label: '泉山区',isLeaf: true},

          {value: '丰县', label: '丰县',isLeaf: true},

          {value: '沛县', label: '沛县',isLeaf: true},

          {value: '铜山县', label: '铜山县',isLeaf: true},

          {value: '睢宁县', label: '睢宁县',isLeaf: true},

          {value: '新沂市', label: '新沂市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '天宁区', label: '天宁区',isLeaf: true},

          {value: '钟楼区', label: '钟楼区',isLeaf: true},

          {value: '戚墅堰区', label: '戚墅堰区',isLeaf: true},

          {value: '新北区', label: '新北区',isLeaf: true},

          {value: '武进区', label: '武进区',isLeaf: true},

          {value: '溧阳市', label: '溧阳市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '沧浪区', label: '沧浪区',isLeaf: true},

          {value: '平江区', label: '平江区',isLeaf: true},

          {value: '金阊区', label: '金阊区',isLeaf: true},

          {value: '虎丘区', label: '虎丘区',isLeaf: true},

          {value: '吴中区', label: '吴中区',isLeaf: true},

          {value: '相城区', label: '相城区',isLeaf: true},

          {value: '常熟市', label: '常熟市',isLeaf: true},

          {value: '张家港市', label: '张家港市',isLeaf: true},

          {value: '昆山市', label: '昆山市',isLeaf: true},

          {value: '吴江市', label: '吴江市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '崇川区', label: '崇川区',isLeaf: true},

          {value: '港闸区', label: '港闸区',isLeaf: true},

          {value: '海安县', label: '海安县',isLeaf: true},

          {value: '如东县', label: '如东县',isLeaf: true},

          {value: '启东市', label: '启东市',isLeaf: true},

          {value: '如皋市', label: '如皋市',isLeaf: true},

          {value: '通州市', label: '通州市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '连云区', label: '连云区',isLeaf: true},

          {value: '新浦区', label: '新浦区',isLeaf: true},

          {value: '海州区', label: '海州区',isLeaf: true},

          {value: '赣榆县', label: '赣榆县',isLeaf: true},

          {value: '东海县', label: '东海县',isLeaf: true},

          {value: '灌云县', label: '灌云县',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '楚州区', label: '楚州区',isLeaf: true},

          {value: '淮阴区', label: '淮阴区',isLeaf: true},

          {value: '清浦区', label: '清浦区',isLeaf: true},

          {value: '涟水县', label: '涟水县',isLeaf: true},

          {value: '洪泽县', label: '洪泽县',isLeaf: true},

          {value: '盱眙县', label: '盱眙县',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '亭湖区', label: '亭湖区',isLeaf: true},

          {value: '盐都区', label: '盐都区',isLeaf: true},

          {value: '响水县', label: '响水县',isLeaf: true},

          {value: '滨海县', label: '滨海县',isLeaf: true},

          {value: '阜宁县', label: '阜宁县',isLeaf: true},

          {value: '射阳县', label: '射阳县',isLeaf: true},

          {value: '建湖县', label: '建湖县',isLeaf: true},

          {value: '东台市', label: '东台市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '广陵区', label: '广陵区',isLeaf: true},

          {value: '邗江区', label: '邗江区',isLeaf: true},

          {value: '维扬区', label: '维扬区',isLeaf: true},

          {value: '宝应县', label: '宝应县',isLeaf: true},

          {value: '仪征市', label: '仪征市',isLeaf: true},

          {value: '高邮市', label: '高邮市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '京口区', label: '京口区',isLeaf: true},

          {value: '润州区', label: '润州区',isLeaf: true},

          {value: '丹徒区', label: '丹徒区',isLeaf: true},

          {value: '丹阳市', label: '丹阳市',isLeaf: true},

          {value: '扬中市', label: '扬中市',isLeaf: true},
...

      {
        ...
        children: [
          ...
          {value: '海陵区', label: '海陵区',isLeaf: true},

          {value: '高港区', label: '高港区',isLeaf: true},

          {value: '兴化市', label: '兴化市',isLeaf: true},

          {value: '靖江市', label: '靖江市',isLeaf: true},

          {value: '泰兴市', label: '泰兴市',isLeaf: true},
